...
export default [
  "",
  {
    ...
    collapsable: true,
    children: [
      "26 届秋招 Go 热题/GO语言中非接口的任意类型T都能调用*T的方法么？反过来呢？",
      "26 届秋招 Go 热题/Go 语言 channel 底层的数据结构是什么？",
      "26 届秋招 Go 热题/Go 语言中 defer 的变量快照在什么情况下会失效？",
      "26 届秋招 Go 热题/Go 语言中 init() 函数在什么时候执行？",
      "26 届秋招 Go 热题/Go 语言中函数返回局部变量的指针是否安全？",
      "26 届秋招 Go 热题/Go 语言中如何访问私有成员？",
      "26 届秋招 Go 热题/Go 语言中怎么实现闭包？闭包的主要应用场景是什么？",
      "26 届秋招 Go 热题/Go 语言中所有的 T 类型都有 *T 类型吗？",
      "26 届秋招 Go 热题/Go 语言中数组与切片有什么异同？",
      "26 届秋招 Go 热题/Go 语言中的 = 和 := 有什么区别？",
      "26 届秋招 Go 热题/Go 语言中的 rune 类型是什么？",
      "26 届秋招 Go 热题/Go 语言中的局部变量是分配在栈上还是堆上？",
      "26 届秋招 Go 热题/Go 语言中的指针的意义是什么？",
      "26 届秋招 Go 热题/Go 语言中触发异常的场景有哪些？",
      "26 届秋招 Go 热题/Go 语言中逃逸分析是怎么进行的？",
      "26 届秋招 Go 热题/Go 语言中通过指针变量 p 访问其成员变量 title，有哪几种方式？",
      "26 届秋招 Go 热题/Go 语言中，为什么小对象多了会造成 GC 压力？",
      "26 届秋招 Go 热题/Go 语言使用断言时会发生拷贝吗？",
      "26 届秋招 Go 热题/Go 语言切片作为函数参数，有哪些注意事项？",
      "26 届秋招 Go 热题/Go 语言切片的容量是如何增长的？",
      "26 届秋招 Go 热题/Go 语言的 GoRoot 和 GoPath 有什么用？",
      "26 届秋招 Go 热题/Go 语言的 context 是什么？有什么作用？",
      "26 届秋招 Go 热题/Go 语言的接口是怎么实现的？",
      "26 届秋招 Go 热题/不分配内存的指针类型能在 Go 语言中使用吗？",
      "26 届秋招 Go 热题/什么是 Go 语言中的深拷贝和浅拷贝？",
      "26 届秋招 Go 热题/协程与进程、线程的区别是什么？协程有什么优势？",
      "26 届秋招 Go 热题/协程可以自己主动让出 CPU 吗？",
      "26 届秋招 Go 热题/如何利用 Go 语言特性设计一个 QPS 为 500 的服务器？",
      "26 届秋招 Go 热题/如何对 Go 语言的 GC 进行调优？",
    ],
  },
  {
    ...
    collapsable: true,
    children: [
      "26 届秋招 Java 热题/JDK 1.8 对 HashMap 除了红黑树还进行了哪些改动？",
      "26 届秋招 Java 热题/JDK 动态代理和 CGLIB 动态代理有什么区别？",
      "26 届秋招 Java 热题/JDK8 有哪些新特性？",
      "26 届秋招 Java 热题/Java 中 ConcurrentHashMap 1.7 和 1.8 之间有哪些区别？",
      "26 届秋招 Java 热题/Java 中 ConcurrentHashMap 的 get 方法是否需要加锁？",
      "26 届秋招 Java 热题/Java 中 HashMap 的扩容机制是怎样的？",
      "26 届秋招 Java 热题/Java 中 ReentrantLock 的实现原理是什么？",
      "26 届秋招 Java 热题/Java 中 volatile 关键字的作用是什么？",
      "26 届秋招 Java 热题/Java 中什么情况会导致死锁？如何避免？",
      "26 届秋招 Java 热题/Java 中有哪些垃圾回收算法？",
      "26 届秋招 Java 热题/Java 中有哪些集合类？请简单介绍",
      "26 届秋招 Java 热题/Java 中的 HashMap 和 Hashtable 有什么区别？",
      "26 届秋招 Java 热题/Java 中的 LinkedHashMap 是什么？",
      "26 届秋招 Java 热题/Java 中的序列化和反序列化是什么？",
      "26 届秋招 Java 热题/Java 并发库中提供了哪些线程池实现？它们有什么区别？",
      "26 届秋招 Java 热题/Java 的 synchronized 是怎么实现的？",
      "26 届秋招 Java 热题/Java 的类加载过程是怎样的？",
      "26 届秋招 Java 热题/Java 线程池有哪些拒绝策略？",
      "26 届秋招 Java 热题/Spring 如何解决循环依赖？",
      "26 届秋招 Java 热题/Synchronized 和 ReentrantLock 有什么区别？",
      "26 届秋招 Java 热题/为什么 HashMap 在 Java 中扩容时采用 2 的 n 次方倍？",
      "26 届秋招 Java 热题/为什么 JDK 1.8 对 HashMap 进行了红黑树的改动？",
      "26 届秋招 Java 热题/为什么 Java 中 HashMap 的默认负载因子是 0.75？",
      "26 届秋招 Java 热题/为什么 Spring 循环依赖需要三级缓存，二级不够吗？",
      "26 届秋招 Java 热题/什么是 Hash 碰撞？怎么解决哈希碰撞？",
      "26 届秋招 Java 热题/什么是 Java 中的 ABA 问题？",
      "26 届秋招 Java 热题/什么是 Java 中的不可变类？",
      "26 届秋招 Java 热题/什么是 Java 中的原子性、可见性和有序性？",
      "26 届秋招 Java 热题/什么是 Java 的 CAS（Compare-And-Swap）操作？",
      "26 届秋招 Java 热题/什么是 Java 的 SPI（Service Provider Interface）机制？",
      "26 届秋招 Java 热题/什么是循环依赖（常问）？",
      "26 届秋招 Java 热题/你了解 Java 线程池的原理吗？",
      "26 届秋招 Java 热题/你使用过哪些 Java 并发工具类？",
      "26 届秋招 Java 热题/使用 HashMap 时，有哪些提升性能的技巧？",
      "26 届秋招 Java 热题/如何合理地设置 Java 线程池的线程数？",
      "26 届秋招 Java 热题/如何在 Java 中控制多个线程的执行顺序？",
      "26 届秋招 Java 热题/数组和链表在 Java 中的区别是什么？",
      "26 届秋招 Java 热题/线程的生命周期在 Java 中是如何定义的？",
      "26 届秋招 Java 热题/说说 AQS 吧？",
      "26 届秋招 Java 热题/说说 Java 中 HashMap 的原理？",
    ],
  },
  {
    title: "26 届秋招前端热题",
    collapsable: true,
    children: [
      "26 届秋招前端热题/CSS 中 display 属性的值及其作用",
      "26 届秋招前端热题/CSS 中可继承与不可继承属性有哪些？",
      "26 届秋招前端热题/Canvas 和 SVG 有什么区别？",
      "26 届秋招前端热题/DOCTYPE（文档类型）的作用是什么？",
      "26 届秋招前端热题/ES6 箭头函数和普通函数有什么区别？",
      "26 届秋招前端热题/HTML 中，img 标签 srcset 属性的作用是什么？",
      "26 届秋招前端热题/HTML 中，title 与 h1 标签的区别是什么？",
      "26 届秋招前端热题/HTML 的 script 标签中 defer 和 async 有什么区别？",
      "26 届秋招前端热题/HTML 的 src 和 href 属性有什么区别？",
      "26 届秋招前端热题/HTML 行内元素有哪些？块级元素有哪些？空（void）元素有哪些？",
      "26 届秋招前端热题/HTML5 相比于 HTML 有哪些更新？",
      "26 届秋招前端热题/JavaScript 中 Object.keys 的返回值是无序的吗？",
      "26 届秋招前端热题/JavaScript 中 null 和 undefined 的区别是什么？",
      "26 届秋招前端热题/JavaScript 有哪些数据类型？它们的区别是什么？",
      "26 届秋招前端热题/JavaScript 的 BigInt 和 Number 类型有什么区别？",
      "26 届秋招前端热题/let、const 和 var 的区别是什么？",
      "26 届秋招前端热题/typeof null 的结果是什么？为什么？",
      "26 届秋招前端热题/typeof 和 instanceof 有什么区别？",
      "26 届秋招前端热题/为什么 JavaScript 中 0.1 + 0.2不等于0.3，如何让其相等？",
      "26 届秋招前端热题/什么是 HTML 语义化？",
      "26 届秋招前端热题/什么是 JavaScript 的尾调用？使用尾调用有什么好处？",
      "26 届秋招前端热题/使用 let 全局声明变量，能通过 window 对象取到吗？",
      "26 届秋招前端热题/使用 link 和 @import 引用 CSS 的区别",
      "26 届秋招前端热题/如何判断 JavaScript 变量是数组？",
      "26 届秋招前端热题/如何解决⻚⾯请求接⼝⼤规模并发问题",
      "26 届秋招前端热题/如何计算 CSS 的优先级？",
      "26 届秋招前端热题/常用的 HTML meta 标签有哪些？",
      "26 届秋招前端热题/有哪些 CSS 选择器？请分别介绍",
      "26 届秋招前端热题/说说你对 JS 作用域的理解？",
      "26 届秋招前端热题/说说你对 fetch 的理解，它有哪些优点和不足？",
      "26 届秋招前端热题/️ TypeScript 有哪些常用类型？",
      "26 届秋招前端热题/️ 什么是 TypeScript 的对象类型？怎么定义对象类型？",
      "26 届秋招前端热题/️ES6 有哪些新特性？",
      "26 届秋招前端热题/️ES6 箭头函数能当构造函数吗？",
    ],
  },
  {
    title: "26 届秋招后端热题",
    collapsable: true,
    children: [
      "26 届秋招后端热题/HTTP 1.0 和 2.0 有什么区别？",
      "26 届秋招后端热题/MySQL 中的数据排序是怎么实现的？",
      "26 届秋招后端热题/MySQL 的 Change Buffer 是什么？它有什么作用？",
      "26 届秋招后端热题/Redis 主从复制的实现原理是什么？",
      "26 届秋招后端热题/Redis 集群的实现原理是什么？",
      "26 届秋招后端热题/让你设计一个 RPC 框架，怎么设计？",
    ],
  },
  {
